package views.interfacePrincipal;
...
import views.interfacePrincipal.paineis.ContainerCROUD;
import views.interfacePrincipal.paineis.ContainerPesquisa;
...
public class TelaPrincipal {
	...
	public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
      ...
      //Configura Janela
      	...
      	frame.setMaximumSize(new Dimension((int)(frame.getWidth()*1.01), (frame.getHeight())));
      	frame.setMinimumSize(new Dimension(((int)(frame.getWidth()*0.58)), (frame.getHeight())));
