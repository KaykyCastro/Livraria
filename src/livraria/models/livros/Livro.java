...
public abstract class Livro {
    ...
    public Livro(String name, String code, String descricao, Enum genero, String autor, Status status) {
        this.name = name;
        this.code = code;
    ...
    public Livro(String name, String code, String descricao, Enum genero, String autor) {
        this(name, code, descricao, genero, autor, Status.DISPONIVEL);
    }
     ...
     * **/
    public void editarLivro(String name, String code, String descricao, Enum genero, String autor, Status status, Calendar dataDevolucao){
        this.name = name;
        this.code = code;
        this.descricao = descricao;
        this.genero = genero;
