...
import views.InterfaceDetalhes.DetalhesCliente;
...
public class HeaderListagem {
	...
	public JPanel retPainel() {
		comboBoxLivro.addActionListener(e -> {
			...
			if(comboBoxLivro.getSelectedItem().equals("")) {
		...
		comboBoxCliente.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(comboBoxCliente.getSelectedItem().equals("Cliente")) {
					DetalhesCliente detCliente = new DetalhesCliente();
					detCliente.getFrame();
				}
			}
		});
